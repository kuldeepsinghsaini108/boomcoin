boom Core version 2.2.1 is now available from:

  <https://github.com/boom-project/boom/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/boom-project/boom/issues>

Compatibility
==============

boom Core is extensively tested on multiple operating systems using
...
boom Core should also work on most other Unix-like systems but is not
...
of Bitcoin that boom was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/boom-project-translations/).
