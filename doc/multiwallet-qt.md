...
In order to support loading of multiple wallets in boom-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is boom.cpp.
...
Changes to boom.cpp
----------------------
boom.cpp is the entry point into boom-qt, and as such, will require some minor modifications to provide hooks for
