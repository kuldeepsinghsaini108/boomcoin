Contributing to boom Core
============================

The boom Core project operates an open contributor model where anyone is
...
The following applies to code changes to the boom Core project, and is not to be
confused with overall boom Network Protocol consensus changes.

Whether a pull request is merged into boom Core rests with the project merge
...
Patches that change boom consensus rules are considerably more involved than
...
Where a patch set proposes to change the boom consensus, it must have been
...
The project leader is the release manager for each boom Core release.
