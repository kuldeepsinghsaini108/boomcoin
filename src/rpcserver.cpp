...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* boom features */
        {"boom", "masternode", &masternode, true, true, false},
        {"boom", "masternodelist", &masternodelist, true, true, false},
        {"boom", "mnbudget", &mnbudget, true, true, false},
        {"boom", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"boom", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"boom", "mnsync", &mnsync, true, true, false},
        {"boom", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"boom", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use boomd, or the -server option to boom-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> boom-cli " + methodname + " " + args + "\n";
}
