                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("boom Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a boom address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and boom: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About boom Core"), this);
    aboutAction->setStatusTip(tr("Show information about boom Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for boom"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your boom addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified boom addresses"));
    ...
    openAction->setStatusTip(tr("Open a boom: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the boom Core help message to get a list with possible boom command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("boom Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to boom network", "", count));
}
...
{
    QString strTitle = tr("boom Core"); // default title
