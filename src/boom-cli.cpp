...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("boom Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  boom-cli [options] <command> [params]  " + _("Send command to boom Core") + "\n" +
                        "  boom-cli [options] help                " + _("List commands") + "\n" +
                        "  boom-cli [options] help <command>      " + _("Get help for a command") + "\n";
