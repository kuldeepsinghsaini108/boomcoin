...
This means one can have an always-on boomd instance running, and another local boomd/boom-qt instance which connects to this node and receives blocks from it.
