...
RESOURCES += src/qt/boom.qrc src/qt/boom_locale.qrc

TRANSLATIONS += src/qt/locale/boom_bg.ts \
                src/qt/locale/boom_de.ts \
                src/qt/locale/boom_en.ts \
                src/qt/locale/boom_es.ts \
                src/qt/locale/boom_fi.ts \
                src/qt/locale/boom_fr.ts \
                src/qt/locale/boom_it.ts \
                src/qt/locale/boom_ja.ts \
                src/qt/locale/boom_pl.ts \
                src/qt/locale/boom_pt.ts \
                src/qt/locale/boom_ru.ts \
                src/qt/locale/boom_sk.ts \
                src/qt/locale/boom_sv.ts \
                src/qt/locale/boom_vi.ts \
                src/qt/locale/boom_zh_CN.ts \
                src/qt/locale/boom_zh_TW.ts
